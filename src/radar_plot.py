...
def normalize_and_plot_radar_charts(df, type_split, type_scaffold, subset, receptor):
    ...
    generators = [
        {'name': f'Molpher{subset}', 'label': 'Molpher', 'linestyle': '-', 'marker': 'o', 'color': 'blue'},
        {'name': f'REINVENT{subset}', 'label': 'REINVENT', 'linestyle': '--', 'marker': 's', 'color': 'green'},
        {'name': f'DrugEx_GT_epsilon_0.1{subset}', 'label': 'DrugEx_GT_epsilon_0.1', 'linestyle': '-.', 'marker': 'D', 'color': 'purple'},
        {'name': f'DrugEx_GT_epsilon_0.6{subset}', 'label': 'DrugEx_GT_epsilon_0.6', 'linestyle': ':', 'marker': 'v', 'color': 'orange'},
        {'name': f'DrugEx_RNN_epsilon_0.1{subset}', 'label': 'DrugEx_RNN_epsilon_0.1', 'linestyle': '-.', 'marker': '*', 'color': 'magenta'},
        {'name': f'DrugEx_RNN_epsilon_0.6{subset}', 'label': 'DrugEx_RNN_epsilon_0.6', 'linestyle': '--', 'marker': '<', 'color': 'brown'},
        {'name': f'GB_GA_mut_r_0.01{subset}', 'label': 'GB_GA_mut_r_0.01', 'linestyle': ':', 'marker': '>', 'color': 'gray'},
        {'name': f'GB_GA_mut_r_0.5{subset}', 'label': 'GB_GA_mut_r_0.5', 'linestyle': ':', 'marker': '>', 'color': 'black'},
        {'name': f'addcarbon{subset}', 'label': 'AddCarbon', 'linestyle': '-', 'marker': 'h', 'color': 'pink'},
    ]
